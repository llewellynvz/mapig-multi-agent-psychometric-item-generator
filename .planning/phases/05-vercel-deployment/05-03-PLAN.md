...
**Note on DEP-08**: This plan documents the deferral of DEP-08 (cold start optimization <5s) to v2 per user decision in 05-CONTEXT.md. DEP-08 is NOT listed in this plan's requirements field because it's deferred (ROADMAP.md line 36), but baseline measurements are captured in Task 2 for future optimization reference.
</objective>
