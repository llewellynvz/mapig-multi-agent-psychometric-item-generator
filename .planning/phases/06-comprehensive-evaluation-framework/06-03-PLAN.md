...
<task type="auto" tdd="true">
  ...
  <action>
Create evaluation suite orchestrator:

1. **backend/evaluation/eval_suite.py**:
```python
import logging
import asyncio
...
2. **Add integration test to tests/test_eval_suite.py**:
```python
...
```
  ...
  <verify>
    <automated>pytest tests/test_eval_suite.py -x</automated>
  </verify>
  <done>
