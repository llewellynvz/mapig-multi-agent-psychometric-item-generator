            ...
            .map(({ entry, index }) => (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  Run: <span className="font-medium text-foreground">{entry.runId}</span>
                </p>
                <p className="text-xs text-muted-foreground">
                  Thread: <span className="font-medium text-foreground">{entry.threadId}</span>
                </p>
                <p className="text-xs text-muted-foreground">
                  Items: <span className="font-medium text-foreground">{entry.itemCount}</span> | Iterations:{" "}
                  <span className="font-medium text-foreground">{entry.iterationCount}</span>
                </p>
                <p className="text-xs text-muted-foreground">
                  Stop reason: <span className="font-medium text-foreground">{entry.stopReason || "N/A"}</span>
                </p>
